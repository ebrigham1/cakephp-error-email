<h3 style="height: 40px; line-height: 40px; background-color: #ec5840; color: #ffffff;">A fatal error has been thrown<?php if ($site): ?> on <?= $site ?><?php endif; ?><?php if ($environment): ?> (<?= $environment ?>)<?php endif; ?></h3>
